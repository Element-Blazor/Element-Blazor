...
- `.NET 10` 是组件库主线和新增项目基线；历史 `demo`、`template`、`community` 子模块不要求先原地全面升级到 .NET 10 才能继续 P1/P2。
...
- P0 项目基线：见 [docs/p0-project-baseline.md](docs/p0-project-baseline.md)
- P0 warning 清单：见 [docs/p0-warning-inventory.md](docs/p0-warning-inventory.md)

## 当前路线

- 🟢 已完成 P0：门面、构建基线、子模块、版本基线和 warning 清单
- 🔵 P1：新增 Element Plus 2.14 CSS 变量层
- 🔵 P2：删除旧公开组件名，切换到 Element Plus `El*` 控件命名
- 🔵 P3：从 `ElButton`、`ElInput`、`ElForm` 开始做视觉和 API 对齐
- 🔵 P4：文档站与组件总览
- 🔵 P5：补齐 Element Plus 组件矩阵缺口
- 🔵 P6：DiscuzX 类社区门面与真实业务示例
- 🔵 P7：测试、发布和长期维护
