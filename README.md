...
有使用遇到问题在星球发贴的，早九点到晚九点，半小时内响应，优先响应，保证提供解决方案（有可能更改你的需求）
，提新功能的，保证在当前版本的下一大版本支持，如果工作量太大，版本可能延后，出bug的，立即开始修复。此待遇仅星球发贴有效
![星球二维码](https://github.com/wzxinchen/Blazui/blob/master/image.png)
