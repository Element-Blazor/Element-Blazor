...
namespace Element
{
    public partial class ElTransitionPath : ElementComponentBase
    {
        [CascadingParameter]
        public ElTransition Transition { get; set; }
        ...
        /// <summary>
        /// 使动画暂停执行，直到 <see cref="ElTransition"/> 的 <see cref="ElTransition.Resume"/> 方法被调用
        /// </summary>
        [Parameter]
