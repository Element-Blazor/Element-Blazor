...
namespace Element.Lang
{
    ...
    /// Lang
    /// </summary>
    public class ElementLang
    {
        public ElementLang(IConfiguration configuration, string locale, Func<HttpClient, string, Task<IConfiguration>> refreshConfiguration, HttpClient httpClient)
        {
